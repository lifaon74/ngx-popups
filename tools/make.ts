...
Task
  ...
  .register('copy-npm-files', () => {
    return Promise.all([
      ...
      fs.copy('./.npmignore', './dist/.npmignore'),
      fs.copy('./lib/style.scss', './dist/style.scss'),
      fs.copy('./lib/style.css', './dist/style.css'),
      fs.copy('./lib/style.css.map', './dist/style.css.map'),
    ]);
  })
